    ...
    ********************--> 
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="${root}/home" class="brand-logo">
                <img class="logo-abbr" src="${root}/resources/assets/images/logo.png" alt="" style="border-radius: 50%;">
...
<!--                                     </a> -->
                                    ...
                                    <c:if test="${ loginUser == null }">
	                                    <a href="${root}" class="dropdown-item">
	                                        <i class="icon-key"></i>
