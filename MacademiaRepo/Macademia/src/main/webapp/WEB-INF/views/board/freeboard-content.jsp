...
<div class="board_wrap">
	 ...
	 <div class="board_page">
    	...
    	<c:forEach begin="${pageVo.startPage}" end="${pageVo.endPage}" var="i">    		    		    	
	    	<c:choose>
		    	<c:when test="${i==pageVo.currentPage}">
		    		<a href="/md/board/free?${queryString}page=${i}" style="background-color: #6667AB; color: white; "  class="num">${i}</a>
		    	</c:when>
		    	<c:otherwise>
	    ...
	    <c:if test="${pageVo.endPage ne pageVo.maxPage}">
	    	<a href="/md/board/free?${queryString}page=${pageVo.endPage + 1}" class="bt next">></a>	    
	    </c:if>	
    </div>
