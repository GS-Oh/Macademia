        ...
        <main>
            ...
            <form action="" method="post" id="detail-form-area">
                <div class="main-table-grid">
                    ...
                    <div>정근수당</div>
                    <div><input class="repair-price-area" type="text" name="attendance"></div>
                    <div>정근가산금</div>
                    <div><input class="repair-price-area" type="text" name="attendancePlus"></div>
                    <div>기술정보수당</div>
                    <div><input class="repair-price-area" type="text" name="technical"></div>
                    <div>특수직무수당</div>
                    <div><input class="repair-price-area" type="text" name="specialduty"></div>
                    <div>비상근무수당</div>
                    <div><input class="repair-price-area" type="text" name="emergency"></div>
                    <div>정액급식비</div>
                    <div><input class="repair-price-area" type="text" name="lunchFee"></div>
                    <div>명절휴가비</div>
                    <div><input class="repair-price-area" type="text" name="holiday"></div>
                    <div>직급보조비</div>
                    <div><input class="repair-price-area" type="text" name="subsidy"></div>
                    <div>대민활동비</div>
                    <div><input class="repair-price-area" type="text" name="publicActivity"></div>
                </div>
