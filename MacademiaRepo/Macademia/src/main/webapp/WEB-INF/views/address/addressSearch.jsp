...
<body>
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <div class="media-left">
                                            		<a href="#"><img src="${root}/resources/assets/images/empty-profile.png" class="img-fluid rounded-circle" alt="" style="width: 150px"></a>
                                        		</div>
                                        		</th>
                                            </tr>
                                        </thead>
    ...
    <!-- Datatable -->
    <script src="${contextPath}/resources/admin/assets/vendor/datatables/js/jquery.dataTables.min.js"></script>
    <script src="${contextPath}/resources/admin/assets/js/plugins-init/datatables.init.js"></script>
