...
<body>
    ...
    <div id="wrap">
        ...
        <main>
            ...
            <div class="main-table-span" style="color:#6667AB"><h1>${prVo.payDate}월 : 급여대장</h1></div>
            ...
            <div class="main-table-span" id="detail-price"><h3>실 수 령 액 : </h3><h3 id="realPay">${prVo.actualPayment}</h3><h3 style = "text-align:left;">원</h3></div>

            <form action="${root}/payroll/history" method="post" id="detail-form-area">
                <div class="main-table-grid">
                    ...
                    <c:if test="${prVo.specialduty ne 0}">
	                    <div>기술정보수당</div>
                ...
                <div style="grid-column: span 2; align-items: center; width: 100%; height: 100%;">
                    <input type="button" value="돌아가기" class="btn btn-light btn-lg" onclick="window.history.back()" style="background-color: #1315a6 ; color:white;">
                </div>
            </form>
        </main>
