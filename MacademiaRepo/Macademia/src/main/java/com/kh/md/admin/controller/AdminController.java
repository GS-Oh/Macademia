...
//		ArrayList<Job> jList = aService.selectPositionList();
//		
...
//			mv.addObject("selectDept", selectDept);
//			mv.addObject("selectPosition", selectPosition);
//			mv.addObject("searchValue", searchValue);
//			mv.addObject("message", message);
...
//		}
//		
//		ArrayList<Position> jList = aService.selectPositionList();
//		if(jList == null) {
//			throw new AdminException("직위 목록을 불러오는데 실패하였습니다.");
//		} 
//		
...
//			jObj = new JSONObject();
//			jObj.put("nodeId", m.getNo());
//			jObj.put("nodeType", "member");
//			jObj.put("nodeName", m.getName());
//			jObj.put("hasChildren", null);
//			jObj.put("jobName", m.getPositionName());
//			
//			jArr.add(jObj);
//		}
//		
